...
public class ProbeAuditSteps extends CommonSteps {
  ...
  public void iSendAGetRequestToWithQueryParams(String endpoint, DataTable dataTable) throws Exception {
    ...
    for (Map<String, String> param : paramsList) {
      String name = param.get("Query param"); // Replace "Column1" with the actual column header name.
  ...
  public void responseShouldContainTheFollowingPositions(DataTable dataTable) throws Exception {
    ...
    for (Map<String, String> expectedPosition : expectedPositions) {
      Assertions.assertThat(actualPositions).anyMatch(actual ->
