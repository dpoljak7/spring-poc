        ...
        .authorizeHttpRequests(
            auth ->
                auth.requestMatchers(unprotectedEndpoints)
                    ...
                    .requestMatchers("/v1/probe/init").hasRole("ADMIN")
                    .requestMatchers("/v1/probe/{probeId}/command").hasRole("ADMIN")
                    .requestMatchers("/v1/probe/{probeId}/autopilot").hasRole("ADMIN")
                    .requestMatchers("/v1/probe/{probeId}/audit").hasAnyRole("ADMIN", "USER")
                    .requestMatchers("/v1/probe/{probeId}/status").hasAnyRole("ADMIN", "USER")
                    .anyRequest()
