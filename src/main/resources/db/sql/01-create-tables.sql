...
(
    ...
    probe_type   VARCHAR2(255) NOT NULL, -- Identifier for each probe as in previous table
    ...
    direction    VARCHAR2(50)  NOT NULL,-- Current direction of the probe (e.g., 'NORTH', 'SOUTH', 'EAST', 'WEST')
...
(
    ...
    username          VARCHAR2(50)  NOT NULL,   -- Username associated with this probe movement
    x_coordinate      INTEGER      NOT NULL,   -- X-coordinate of the probe
    y_coordinate      INTEGER      NOT NULL,   -- Y-coordinate of the probe
    direction         VARCHAR2(50)  NOT NULL,-- Current direction of the probe (e.g., 'NORTH', 'SOUTH', 'EAST', 'WEST')
    command_executed  VARCHAR2(255) NOT NULL,   -- Command issued to move to this position
